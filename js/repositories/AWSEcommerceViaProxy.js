storeApp.factory ("ASWECommerceRepository", function ($http, $q, $sce) {
    ...
    self.itemSearch = function (keyword) {
        ...
        url = "ba-simple-proxy.php?url=" + encodeURIComponent(url);
        
        $http. get (url) .success (function (data) {
            var dataAsJson = new X2JS().xml_str2json(data.contents);
            var items = dataAsJson.ItemSearchResponse.Items.Item;
