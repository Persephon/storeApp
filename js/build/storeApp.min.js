...
storeApp.directive("autoSearchBox",function(a,$timeout){return{restrict:"A",replace:!0,scope:{refreshResults:"&",hideLoader:"&",showLoader:"&"},template:'<input type="text" ng-model="searchParam" placeholder="search" class="form-control" />',link:function(b,c){var d=function(){b.showLoader(),a.itemSearch(b.searchParam).then(function(a){b.hideLoader(),b.refreshResults({items:a})})};b.searchParam="Book",d();var e;c.on("keyup",function(){e&&$timeout.cancel(e),e=$timeout(function(){d()},700)})}}});;/*! storeApp 2013-12-27 */
